      ...
      <div className="container-custom grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div className="md:col-span-3 grid grid-cols-1 sm:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="mailto:info@hack4maha.com" className="text-gray-300 hover:text-cyber-teal transition-all duration-200">info@hack4maha.com</a></li>
              <li><a href="tel:+912345678900" className="text-gray-300 hover:text-cyber-teal transition-all duration-200">+91 1234567890</a></li>
            </ul>
          </div>
        </div>
      </div>
